---
layout: post
title: "A random matrix debunked my SAE-geometry result. Every time."
date: 2026-07-02
---
...
GPT-2-small + jbloom residual SAEs · five function proxies · spectrum-matched
nulls, synthetic-validated*
...
Sfn is just cosine of *d* under a fixed quadratic form `M = W_U^T W_U`, while Sgeo
...
Fix: use a proxy that isn't linear in the decoder direction. Inject `α · d_i` into
